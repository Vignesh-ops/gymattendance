    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 w-full max-w-md border border-gray-700 shadow-2xl">
        <div className="text-center mb-6">
          <QrCode className="mx-auto text-orange-500 mb-4" size={48} />
        ...
        <div className="border-t border-gray-700 pt-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button 
              ...
              className="bg-orange-500 text-white py-3 rounded-lg hover:bg-orange-600 transition-all font-semibold"
            >
              Register
            </button>
          </div>
